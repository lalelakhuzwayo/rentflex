-- ====================================================================
-- RENTFLEX - COMPLETE SUPABASE & POSTGRESQL DATABASE SCHEMA DDL
-- ====================================================================

-- 1. Enable Required PostgreSQL Extensions & Auth Schema Setup
...
CREATE OR REPLACE FUNCTION auth.uid() RETURNS uuid AS $$ SELECT '00000000-0000-0000-0000-000000000001'::uuid; $$ LANGUAGE sql STABLE;
...
CREATE TABLE IF NOT EXISTS public.profiles (
    ...
    full_name TEXT,
    phone TEXT,
    user_type TEXT CHECK (user_type IN ('tenant', 'rentee', 'landlord', 'contractor', 'admin', 'sysAdmin')) DEFAULT 'rentee',
...
-- ====================================================================
-- 7. JOBS TABLE (Maintenance / Repairs posted by Landlords)
-- ====================================================================
...
-- ====================================================================
-- 8. CONTRACTOR BIDS TABLE (Bids on Landlord Maintenance Jobs)
-- ====================================================================
...
-- ====================================================================
-- 9. PROPERTY RENT BIDS TABLE (Bids placed by Tenants on Properties)
-- ====================================================================
...
-- ====================================================================
-- 15. APPLICATIONS TABLE (Tenant Screening Applications)
-- ====================================================================
...
-- ====================================================================
-- 19. SUPABASE STORAGE BUCKET SETUP ('rentflex-files')
-- ====================================================================
INSERT INTO storage.buckets (id, name, public)
VALUES ('rentflex-files', 'rentflex-files', true)
ON CONFLICT (id) DO NOTHING;

DROP POLICY IF EXISTS "Public storage read" ON storage.objects;
DROP POLICY IF EXISTS "Public storage insert" ON storage.objects;

CREATE POLICY "Public storage read" ON storage.objects FOR SELECT USING (bucket_id = 'rentflex-files');
CREATE POLICY "Public storage insert" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'rentflex-files');
