    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                // Gate on the server's auth result, NOT appClient.auth.isAuthenticated():
        ...
        return (
            <AuthLayout icon={ShieldCheck} title="Authorize access">
                <div className="flex items-center justify-center py-8">
                    <BlockLoader size="sm" variant="grid" text="Authorizing..." />
                </div>
            </AuthLayout>
        );
    }
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-3">
                ...
                <Button
                    className="flex-1 h-12 font-medium bg-zinc-900 hover:bg-zinc-800 text-white flex items-center justify-center gap-2"
                    disabled={submitting}
                    onClick={() => respond("approve")}
                >
                    {submitting ? <BlockLoader size="xs" variant="inline" color="light" /> : null}
                    Approve
                </Button>
            </div>
        </AuthLayout>
